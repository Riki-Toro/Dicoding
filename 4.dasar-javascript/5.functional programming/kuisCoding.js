...
// filter
let hasilFilter = books.filter((book) => book.sales > 1000000);

// console.log(hasilFilter);
let hasilMap = hasilFilter.map((hasil) => {
    return `${hasil.author} adalah penulis buku ${hasil.title} yang sangat hebat!`;
    // console.log(`${hasil.author} adalah penulis buku ${hasil.title} yang sangat hebat!`);
});
greatAuthors = hasilMap;
